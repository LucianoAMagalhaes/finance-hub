...
// including when one of the two providers (Yahoo, Tesouro Direto) is down and
// the other still delivered.
  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <button
        ...
        onClick={handleClick}
        disabled={isPending}
        title="Busca o preço atual do que é negociado na B3 (Yahoo Finance) e dos títulos do Tesouro Direto"
